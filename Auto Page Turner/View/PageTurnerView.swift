...
struct PageTurnerView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            print("🟢 onAppear fired for: \(score.title)") // Add this print!
            viewModel.pageBreaks = score.pageBreaks
            viewModel.loadJSON(fileName: score.jsonFileName)
        }
    }
    ...
    var pdfSection: some View {
        if let url = Bundle.main.url(forResource: score.pdfFileName, withExtension: "pdf") {
